-----Pour avoir une idée de la quantité de processeur utilisée actuellement par les requêtes, par rapport à la capacité globale du processeur
...
-----requêtes actuellement responsables de l'activité élevée du processeur
...
-----requêtes historiques liées au processeur 
